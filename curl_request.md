...
> **Important:** Update `authenticity_token`, `_gh_sess` cookie, `user_session` cookie,
> `__Host-user_session_same_site` cookie, `x-fetch-nonce`, and `logged_in` cookie before running.
...
curl 'https://github.com/settings/education/developer_pack_applications' \
  ...
  -H 'cookie: _octo=GH1.1.2049350369.1775031132; GHCC=Required:1-Analytics:1-SocialMedia:1-Advertising:1; MicrosoftApplicationsTelemetryDeviceId=994ff2f5-612b-43d1-9638-058d8e3c26d9; MSFPC=GUID=6785cbfc955746e09a4aaafd557d5d10&HASH=6785&LV=202604&V=4&LU=1775031148495; _device_id=66185fd411ec6318e2db9f46f13696a2; saved_user_sessions=272754949%3AndrcVERmQquyhAOsQR2lCexaGMtdDIf2nhxix_60HS-Az0mm; user_session=UPDATE_ME; __Host-user_session_same_site=UPDATE_ME; logged_in=yes; dotcom_user=gitsparkdev; color_mode=%7B%22color_mode%22%3A%22auto%22%2C%22light_theme%22%3A%7B%22name%22%3A%22light%22%2C%22color_mode%22%3A%22light%22%7D%2C%22dark_theme%22%3A%7B%22name%22%3A%22dark%22%2C%22color_mode%22%3A%22dark%22%7D%7D; preferred_color_mode=light; tz=Asia%2FJakarta; _gh_sess=UPDATE_ME' \
  ...
  -H 'x-fetch-nonce: UPDATE_ME' \
  -H 'x-github-client-version: cb8ac222df81bbf3e5fb8886d3abee56e258f16a' \
...
| Field | Where | Current |
|-------|-------|---------|
| `authenticity_token` | `--data-urlencode` | `UPDATE_ME` |
| `user_session` | cookie | `UPDATE_ME` |
| `__Host-user_session_same_site` | cookie | `UPDATE_ME` |
| `_gh_sess` | cookie | `UPDATE_ME` |
| `x-fetch-nonce` | header | `UPDATE_ME` |
